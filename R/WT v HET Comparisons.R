...
data <-c('/Users/stevensu/Desktop/Korb Lab/MEA Analysis/Steven_MEA/ra nxn and Sean 6-4-24/Plate 1/6-04-24 nxn DIV 11 PLATE 1(002)(001).csv',
         ...
         '/Users/stevensu/Desktop/Korb Lab/MEA Analysis/Steven_MEA/ra nxn and Sean 6-7-24/Plate 2/div 14 nxn 6-7-24 plate 3(001)(001).csv',
...
# print(p)
# 
# setwd("/Users/stevensu/Desktop/Korb Lab/MEA Analysis/Steven_MEA/WT v HET Plots")
# ggsave(paste(process_file_name(file), '.png', sep = ""), plot = p, width = 15, height = 10, dpi = 300)
# }
