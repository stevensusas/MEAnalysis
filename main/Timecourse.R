...
for (metric in metrics) {
  ...
  obj$rename_treatment_batch('L', 'Control shRNA')
  obj$rename_treatment_batch('58', 'Xrn2 shRNA 1')
  obj$rename_treatment_batch('61', 'Xrn2 shRNA 2')
  obj$rename_treatment_batch('59', 'Xrn2 Exon2 shRNA')
  obj$rename_treatment_batch('A4', 'Xrn2 ASD-Linked Isoform shRNA')
  ...
  setwd('/Users/stevensu/Desktop/Korb Lab/Sean Samples Run/Timecourse/Min 5')
...
for (metric in metrics) {
  ...
  setwd('/Users/stevensu/Desktop/Korb Lab/Sean Samples Run/Timecourse/Min 30')
  ggsave(paste(metric, '.pdf', sep = ""), width = 15, height = 15, dpi = 300)
}
