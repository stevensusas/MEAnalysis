...
# File paths for Plate 1 (5 minute recordings)
file_paths <- c(
...
for (metric in metrics) {
  # Run the analysis
  plot <- run_mea_analysis(file_paths, conditions, metric, control)
  
  # Save the plot
  ggsave(paste0("/Users/stevensu/Desktop/Korb Lab/MEA Analysis/Steven_MEA/Results/Time Course Plots Bucketed/Plate 1/5min/", metric, '.png'), 
