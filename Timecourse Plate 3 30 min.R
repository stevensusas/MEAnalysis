...
file_mapping <- c(
  "ra nxn div 17 plate3 spontaneous 30min in(000)(000).csv" = "DIV 17",
  "ra nxn div 18 plate 3 spontaeous 3 30min(000)(000).csv" = "DIV 18",
  "ra nxn div 20 plate3 spontaneous 30min(000)(000).csv" = "DIV 20",
  "ra nxn div 21 plate 3 spontaneous 30min(000)(000).csv" = "DIV 21",
  "ra nxn div 22 plate3 spontaneaous 30min(000)(000).csv" = "DIV 22",
  "ra nxn plate3 spontaneous 30min(000)(000).csv" = "DIV 24",
  "ra nxn plate3 spontaneous 30min(000)(000).csv" = "DIV 25"
)
...
# File paths for Plate 3 (30 minute recordings)
file_paths <- c(
...
for (metric in metrics) {
  ...
  ggsave(paste("/Users/stevensu/Desktop/Korb Lab/MEA Analysis/Steven_MEA/Results/Time Course Plots Bucketed/Plate 3/30min/", paste(metric,'.png')), width = 12, height = 20, units = "in")
